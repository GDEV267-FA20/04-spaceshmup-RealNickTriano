...
public class Enemy_4 : Enemy
{
    ...
    {                                            // c
        ...
        // u increased from 0 to 1 with time as movement occurs
        // once it reaches 1 the movement is done and we can set up the next move
        if (u >= 1)
        {
        ...
        pos = (1 - u) * p0 + u * p1;          // Simple linear interpolation, ah yes quite simple really       
    ...
    {                                // e
        ...
        switch (other.tag)
        {
            ...
            case "ProjectileHero":
                ...
                //finds game object that was hit
                // contacts[] is an array of ContactPoints  thisCollider is the collider for the part that was hit
